...
WORKER_ENV="MAX_CONCURRENT_TRANSCRIPTIONS=$MAX_CONCURRENT_TRANSCRIPTIONS,GEMINI_MODEL=$GEMINI_MODEL,GCP_PROJECT_ID=$PROJECT_ID,GCP_REGION=$REGION,TRANSCRIPTION_JOBS_COLLECTION=$JOBS_COLLECTION,TRANSCRIPTION_RESULTS_BUCKET=$RESULTS_BUCKET,TRANSCRIPTION_HLS_ALLOWED_HOSTS=$HLS_ALLOWED_HOSTS"
